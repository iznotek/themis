...
static int secure_message_verify_overlong_elliptic_signatures()
{
    ...
    std::vector<uint8_t> public_key = as_bytes(buf_public_key);

    uint8_t buf_signature_1[] = {
    ...
    signatures.push_back(as_bytes(buf_signature_1));
    signatures.push_back(as_bytes(buf_signature_2));
    signatures.push_back(as_bytes(buf_signature_3));
    signatures.push_back(as_bytes(buf_signature_4));
    signatures.push_back(as_bytes(buf_signature_5));
    signatures.push_back(as_bytes(buf_signature_6));
    signatures.push_back(as_bytes(buf_signature_7));
